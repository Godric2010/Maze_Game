...
namespace yarep::physics::collision {
    ...
    public:
        ...
        virtual void Update(ecs::EntityId entity, const AABB& new_aabb) = 0;

        virtual void QueryAabb(const AABB& area, std::vector<ecs::EntityId>& out, const QueryFilter* filter) = 0;
    };
}
