...
namespace Engine::Renderer {
    inline MeshAsset CreateUiPrimitive() {
        ...
        ui_mesh_primitive.vertices = std::vector{
            MeshVertex{glm::vec3{0, 0, 0}, glm::vec2{0, 0}},
            MeshVertex{glm::vec3{1, 0, 0}, glm::vec2{1, 0}},
            MeshVertex{glm::vec3{1, 1, 0}, glm::vec2{1, 1}},
            MeshVertex{glm::vec3{0, 1, 0}, glm::vec2{0, 1}},
        };
