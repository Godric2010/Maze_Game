...
namespace Engine::Renderer::ShaderManagement {
    ShaderManager::ShaderManager(Environment::Files::IFileReader* file_reader) {
    ...
    void ShaderManager::LoadShader(const std::string& shader_name) {
        ...
        const auto vert_shader_content = m_file_reader->ReadTextFromFile(
        ...
        const auto frag_shader_content =m_file_reader->ReadTextFromFile(
